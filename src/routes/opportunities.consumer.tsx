...
export const Route = createFileRoute("/opportunities/consumer")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Access daily needs, essentials and services at fair cooperative prices as a Pavitram consumer." },
      { property: "og:title", content: "Join as a Consumer — Pavitram India" },
      { property: "og:description", content: "Ethical products and services at cooperative prices." },
    ],
  }),
  component: () => <OppDetailPage d={{
    ...
    label: "Consumer",
    Icon: User,
    intro: "Access high-quality, ethically sourced products and services at fair cooperative prices. Become part of a network that puts member needs ahead of margins, with transparent pricing and verified quality at every step.",
    benefits: [
