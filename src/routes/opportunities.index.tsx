  ...
  head: () => ({
    meta: [
      { title: "Opportunities — Pavitram India" },
      {
        name: "description",
        content:
          "Join as a Consumer, Merchant, Investor or Career associate — find your role in the cooperative network.",
      },
      { property: "og:title", content: "Opportunities — Pavitram India" },
      {
        property: "og:description",
        content: "Explore how you can contribute to the Pavitram network.",
      },
    ],
  }),
    ...
    <>
      <section className="relative isolate overflow-hidden bg-navy pt-36 pb-24">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <Reveal delay={0.05}>
            <GoldLabel>Grow With Us</GoldLabel>
          </Reveal>
          <Reveal delay={0.1}>
            <h1 className="mt-5 font-display text-5xl font-bold text-white md:text-7xl">
              Opportunities
            </h1>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-4 font-deva text-2xl text-gold">अवसर और योगदान</p>
          </Reveal>
          <Reveal delay={0.3}>
            <p className="mx-auto mt-6 max-w-xl text-white/75">
              Explore how you can contribute to the Pavitram network and find the right role that
              aligns with your skills, resources, and vision.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="bg-haze py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6">
          <Reveal className="text-center">
            <h2 className="font-display text-4xl font-bold text-ink md:text-[48px]">
            ...
            {CARDS.map((c, i) => (
              <Reveal key={c.title} delay={(i % 2) * 0.08}>
                <div className="group flex h-full flex-col rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgba(13,27,62,0.06)] ring-1 ring-transparent transition-all duration-300 hover:-translate-y-1.5 hover:ring-gold hover:shadow-[0_24px_60px_-12px_rgba(13,27,62,0.18)]">
                  ...
                  <p className="mt-6 text-[11px] font-bold uppercase tracking-[0.22em] text-mist/80">
                    Key Benefits
                  </p>
                  ...
                  <Link
                    to={c.to}
                    className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-full border-2 border-ink/15 px-5 py-3 text-sm font-bold text-ink transition group-hover:border-navy group-hover:bg-navy group-hover:text-white"
                  >
      ...
      <section className="bg-navy py-24 md:py-32">
        <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2 lg:gap-20">
          <Reveal>
            ...
            <h2 className="mt-5 font-display text-3xl font-bold text-white md:text-[42px]">
              A Platform Built for People, Not Profits
            </h2>
            <p className="mt-5 text-white/65">
              Pavitram India is not just a company; it's a movement to create a fair, transparent,
              and sustainable ecosystem where every member shares in the growth and success.
            </p>
            <div className="mt-8 grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={p.label}
                  className="flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-3 text-sm text-white"
                >
          ...
          <Reveal delay={0.1}>
            <div className="rounded-3xl border border-gold/30 bg-white/5 p-8 backdrop-blur-xl shadow-[0_30px_80px_-20px_rgba(0,0,0,0.5)] md:p-10">
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-white/70">
                In our network, a manufacturer gets fair prices, a worker gets dignity, and a
                consumer gets purity. No middlemen, no exploitation.
              </p>
              <div className="mt-8">
                <ProgressBar />
              </div>
              <Link
                to="/contact"
                className="mt-8 inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-3.5 text-sm font-bold text-navy transition hover:bg-gold"
              >
