  ...
  head: () => ({
    meta: [
      { title: "Merchant Opportunities — Pavitram India" },
      {
        name: "description",
        content:
          "Partner with Pavitram India to reach a dedicated community customer base and grow ethically.",
      },
      { property: "og:title", content: "Join as a Merchant — Pavitram India" },
      {
        property: "og:description",
        content: "Transparent B2B and B2C partnerships for ethical growth.",
      },
    ],
  }),
  component: () => (
    <OppDetailPage
      d={{
        ...
        Icon: Store,
        intro:
          "Partner with us to reach a dedicated community customer base and grow your business with transparent partnerships. List products and services across a multi-vendor, multi-location cooperative framework.",
        benefits: [
