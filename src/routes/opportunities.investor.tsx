  ...
  head: () => ({
    meta: [
      { title: "Investor Opportunities — Pavitram India" },
      {
        name: "description",
        content:
          "Invest in community-driven projects with transparent returns targeting 12%+ cooperative annual returns.",
      },
      { property: "og:title", content: "Invest with Pavitram India" },
      {
        property: "og:description",
        content: "Transparent cooperative investment with community impact.",
      },
    ],
  }),
  component: () => (
    <OppDetailPage
      d={{
        ...
        Icon: TrendingUp,
        intro:
          "Invest in community-driven projects with transparent returns and a focus on collective growth. Every project is backed by clear ownership, audited reporting, and shared upside with the community.",
        benefits: [
